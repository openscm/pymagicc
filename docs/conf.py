...
latex_documents = [
    (master_doc, "Pymagicc.tex", "Pymagicc Documentation", author, "manual")
]
...
man_pages = [(master_doc, "pymagicc", "Pymagicc Documentation", [author], 1)]
...
texinfo_documents = [
    (
        master_doc,
        "Pymagicc",
        "Pymagicc Documentation",
        author,
        "Pymagicc",
        "Python Wrapper for Simple Climate Model MAGICC",
        "Miscellaneous",
    )
]
