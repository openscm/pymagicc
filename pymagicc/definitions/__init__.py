...
def get_magicc7_to_openscm_variable_mapping(inverse=False):
    ...
    rf_updates = {
        ...
        "OZTOTAL_RF": "Radiative Forcing|Ozone",
    ...
    replacements.update(
        {
            ...
            "CO2PF_EMIS": "Net Land to Atmosphere Flux|CO2|Earth System Feedbacks|Permafrost",
            "CH4PF_EMIS": "Net Land to Atmosphere Flux|CH4|Earth System Feedbacks|Permafrost",
...
def get_pint_to_fortran_safe_units_mapping(inverse=False):
    ...
    dict
        Dictionary of mappings
    """
    replacements = {"^": "super", "/": "per", " ": "_", "**": "super"}
    if inverse:
        replacements = {v: k for k, v in replacements.items() if k not in ["**"]}
